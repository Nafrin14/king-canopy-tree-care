      ...
      `,style:{background:`linear-gradient(160deg, #1c2f12 0%, #2a4018 45%, #1a3010 100%)`},children:[(0,s.jsx)(`div`,{"aria-hidden":`true`,className:`
        ...
        `,children:[(0,s.jsx)(`span`,{className:`text-[10px] tracking-widest uppercase mb-1`,children:`Scroll`}),(0,s.jsx)(`svg`,{className:`w-4 h-4`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,s.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M19 9l-7 7-7-7`})})]}),(0,s.jsx)(C,{isOpen:c,onClose:()=>l(!1)})]})}var O=[{icon:`🛡️`,title:`Fully Insured`,desc:`Complete liability and workers comp coverage protects you on every job.`},{icon:`🎓`,title:`Certified Arborists`,desc:`Our team holds ISA certifications and ongoing training in tree science.`},{icon:`♻️`,title:`Eco-Friendly`,desc:`We chip and recycle all debris — minimizing waste on every project.`},{icon:`💰`,title:`Fair Pricing`,desc:`Transparent, upfront quotes with no hidden fees or surprise charges.`}];function k(){return(0,s.jsx)(`section`,{id:`about`,className:`py-20 lg:py-28 bg-white`,children:(0,s.jsx)(`div`,{className:`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8`,children:(0,s.jsxs)(`div`,{className:`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center`,children:[(0,s.jsxs)(`div`,{className:`relative`,children:[(0,s.jsxs)(`div`,{className:`relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/5] max-w-lg mx-auto`,children:[(0,s.jsx)(`img`,{src:u,alt:`King Canopy arborist at work`,width:`190`,height:`260`,loading:`lazy`,decoding:`async`,className:`absolute inset-0 w-full h-full object-cover`}),(0,s.jsx)(`div`,{"aria-hidden":`true`,className:`absolute inset-0 bg-gradient-to-t from-green-950/60 via-transparent to-transparent`}),(0,s.jsxs)(`div`,{className:`absolute bottom-5 left-5 bg-black/40 backdrop-blur-md border border-white/30 rounded-2xl px-4 py-3`,children:[(0,s.jsx)(`p`,{className:`text-white text-xs font-medium`,children:`Caring for trees`}),(0,s.jsx)(`p`,{className:`text-white font-extrabold text-xl leading-tight`,children:`since 2009`})]})]}),(0,s.jsxs)(`div`,{className:`
              ...
              `,children:[(0,s.jsx)(`div`,{className:`
                  ...
                  text-2xl
                  flex-shrink-0
                `,"aria-hidden":`true`,children:`⭐`}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`p`,{className:`text-2xl font-extrabold text-gray-900 leading-none`,children:`4.9/5`}),(0,s.jsx)(`p`,{className:`text-gray-600 text-xs mt-1`,children:`500+ Google Reviews`})]})]})]}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`span`,{className:`text-green-700 font-semibold text-sm uppercase tracking-widest`,children:`About Us`}),(0,s.jsxs)(`h2`,{className:`mt-2 text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight`,children:[`Local Experts Who`,(0,s.jsxs)(`span`,{className:`text-green-700`,children:[` `,`Care for Your Trees`]})]}),(0,s.jsx)(`p`,{className:`mt-5 text-lg text-gray-600 leading-relaxed`,children:`King Canopy Tree Care has been serving homeowners and businesses since 2009. Founded by a certified arborist with a passion for the outdoors, we've grown into a trusted team of professionals who treat every tree — and every client — with respect.`}),(0,s.jsx)(`p`,{className:`mt-4 text-gray-600 leading-relaxed`,children:`We believe healthy trees make for healthier communities. That's why we combine scientific knowledge with hands-on experience to deliver results that are safe, sustainable, and beautiful.`}),(0,s.jsx)(`div`,{className:`mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4`,children:O.map(e=>(0,s.jsxs)(`div`,{className:`
                    flex
                    items-start
                    gap-3
                    p-4
                    ...
                    border
                    border-green-100
                  `,children:[(0,s.jsx)(`span`,{className:`text-2xl flex-shrink-0`,"aria-hidden":`true`,children:e.icon}),(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`p`,{className:`font-semibold text-gray-900 text-sm`,children:e.title}),(0,s.jsx)(`p`,{className:`text-gray-600 text-sm mt-1 leading-relaxed`,children:e.desc})]})]},e.title))}),(0,s.jsxs)(`a`,{href:`#contact`,className:`
                mt-8
                inline-flex
                items-center
                gap-2
